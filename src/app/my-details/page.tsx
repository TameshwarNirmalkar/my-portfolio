                  ...
                  <div className="flex-auto sm:ml-5 justify-evenly">
                    ...
                    <div className="flex flex-row items-center">
                      ...
                      <div className="flex-1 inline-flex   items-center ml-2 space-x-2">
                        ...
                        <a
                          href="https://www.linkedin.com/in/tameshwar-nirmalkar"
                          target="_blank"
                        >
                          <svg
                            className="cursor-pointer w-5 h-5 p-1  rounded-2xl hover:bg-orange-500 hover:text-white transition ease-in duration-300"
                        ...
                        <a
                          href="https://twitter.com/tnirmalkar?lang=en"
                          target="_blank"
                        >
                          <svg
                  ...
                  <div className="p-5 flex-auto justify-center">
                    <div className="text-md text-gray-400 px-4">
                      <ul className="list-none md:list-disc">
                        <li>
                          Working as Freelauncer with around 12 years of
                          experience on front-end React, Angular, Vue,
                          JavaScript based web development.
                        </li>
                        <li>
                          Hands on experience in Nodejs, ReactJs, Redux, Ant
                          Design, Angular, Angular Material, HTML5, CSS3,
                          Tailwind, Bootstrap, SCSS, JavaScript, Rest API.
                        </li>
                        <li>
                          Knowledge of database concepts of SQL such as MongoDB,
                          PostgreSQL, MySql.
                        </li>
                        <li>Worked on Agile Methodology.</li>
                        <li>
                          Attended Adobe UX Trainings and Usability Workshops to
                          Bring UX into Consideraton when Developing Web
                          Applicatons.
                        </li>
                      </ul>
                    </div>
